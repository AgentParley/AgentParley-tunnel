...
const (
	TunnelService_Connect_FullMethodName = "/agentparley.tunnel.v1.TunnelService/Connect"
)
...
var TunnelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agentparley.tunnel.v1.TunnelService",
